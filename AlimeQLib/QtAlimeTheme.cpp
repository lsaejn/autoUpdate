...
QtAlimeThemePrivate::~QtAlimeThemePrivate()
{
}

QColor QtAlimeThemePrivate::rgba(int r, int g, int b, qreal a) const
{
    QColor color(r, g, b);
    color.setAlphaF(a);
    return color;
...
QtAlimeTheme::QtAlimeTheme(QObject *parent)
    : QObject(parent),
      d_ptr(new QtAlimeThemePrivate(this))
{
...
QtAlimeTheme::~QtAlimeTheme()
{
}

QColor QtAlimeTheme::getColor(const QString &key) const
{
    Q_D(const QtAlimeTheme);
...
void QtAlimeTheme::setColor(const QString &key, const QColor &color)
{
    Q_D(QtAlimeTheme);
...
void QtAlimeTheme::setColor(const QString &key, Material::Color color)
{
    Q_D(QtAlimeTheme);
...
QIcon QtAlimeTheme::icon(QString category, QString icon)
{
